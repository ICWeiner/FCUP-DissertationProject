...
To obtain this Ticket in the context of the flask app, please use the function ```get_flask_proxmox_session``` found in ```proxmox_session.py``` under the ```vm``` blueprint.
