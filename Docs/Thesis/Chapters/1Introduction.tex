...
Digital change has greatly raised the need for those who work in the field of\ac{cs}. Among the various specializations within it, network 
administration continues to be essential, due to the fundamental role that networks play in supporting the operation and connectivity 
...
This project aims to build an initial version of a system capable of assisting the training in the topic of network administration, building upon previous 
