...
\section{Performance Evaluation}
    ...
    Each test scenario was repeated three times per implementation/batch size combination. The reported values represent 
    the average across these repetitions.
    ...
    proceed without any concurrency restrictions.
        ...
        \subsubsection{Task 1: Template VM Creation}
            ...
            \begin{table}[ht]
                \centering
                \caption{Comparison of Average Execution Time (in seconds)}
                \begin{tabular}{|l|c|c|c|}
                    \hline
                    \textbf{Task} & \textbf{Flask} & \textbf{Flask + Celery} & \textbf{FastAPI} \\
                    \hline
                    Template\ac{vm} creation & 36.942013 & 34.927078 & 32.197323 \\
                    \hline
                \end{tabular}
                \label{tab:task1_plot}
            \end{table}

            As can be confirmed in Table~\ref{tab:task1_plot} the average execution times are very similar across all three implementations, 
        ...
        \subsubsection{Task 2: VM Cloning}            
            ...
            \begin{figure}[ht]
                ...
                \begin{tikzpicture}
                    \begin{axis}[
                        title={Average Execution Time for Batch of VM Cloning},
                        ybar,
                        bar width=12pt,
                        enlargelimits=0.12,
                        ylabel={Time (s)},
            ...
            \begin{figure}[ht]
                ...
                \begin{tikzpicture}
                    \begin{axis}[
                            title={Execution Time Deviation for Batch VM Cloning},
                            ylabel={Deviation (\%)},
                            boxplot/draw direction=y, % Vertical boxplot
                            xtick={1,2,3},
                            xticklabels={Flask,Flask + Celery,FastAPI},
        ...
        \subsubsection{Task 3: VM Deleting}
            ...
            \begin{figure}[ht]
                ...
                \begin{tikzpicture}
                    \begin{axis}[
                        title={Average Execution Time for Batch VM Deleting},
                        ybar,
                        bar width=12pt,
                        enlargelimits=0.12,
                        ylabel={Time (s)},
            ...
            \begin{figure}[ht]
                ...
                \begin{tikzpicture}
                    \begin{axis}[
                            title={Execution Time Deviation for Batch VM Deleting},
                            ylabel={Deviation (\%)},
                            boxplot/draw direction=y, % Vertical boxplot
                            xtick={1,2,3},
                            xticklabels={Flask,Flask + Celery,FastAPI},
                    ...
                    \end{axis}
                \end{tikzpicture}
                \caption{Boxplot comparison of execution time variability for VM deleting.}
            ...
            \begin{figure}[ht]
                ...
                \begin{tikzpicture}
                    ...
                    \end{axis}
                \end{tikzpicture}
                \caption{Boxplot comparison of execution time variability of Flask and FastAPI for VM deleting.}
...
\section{System Usage}
    ...
    \subsection{Create a new exercise and enroll students}
        ...
        \begin{itemize}
             ...
             on the specified devices. Currently, only ping and traceroute commands are supported. These validations will be executed 
