...
\section{Virtualization}
  ...
  \begin{itemize}
    \item \textbf{Emulation} is the process of replicating the behavior of a hardware or software system in a virtual environment, 
...
\label{sec:chap2_gns3}
  ...
  \subsection{Architecture}
    ...
    \subsubsection{Controller}
      ...
      of hosting one or more emulator instances, varying depending on their complexity. The controller also exposes a
      \ac{rest}\ac{api} providing the ability to interact with the software programatically. All communication is done over
    ...
    \subsubsection{Compute}
      ...
      \begin{itemize}
          ...
          Supported but not recommended as it is deemed inferior when compared to VIRL.
          \item \textbf{\ac{qemu}} - Used to emulate a wide variety of devices such as\ac{vm}s.
          \begin{itemize}
            \item \textbf{VIRL} To use VIRL\ac{ios} images on\ac{qemu} it is required to purchase a licence from Cisco.
    ...
    \subsubsection{GUI}
      ...
      is written in Python and uses the Qt framework for the\ac{gui}. The gns3-web, seen in Figure~\ref{fig:gns3-web-ui}, is 
    ...
    to setup software on their own or interact with the underlying host\ac{vm}.
...
\section{Virtualized Work Environments}
  ...
  virtualized network, consisting of multiple devices. Then, by virtualizing these work environments on a virtualization platform, we can 
...
\section{LDAP}
  ...
  computers to accessing library resources or online learning platforms. In\ac{dcc},\ac{ldap} is used to authenticate 
  into labs' computers.
  ...
  system to have the capability to interact with LDAP in order to correctly authenticate users.
