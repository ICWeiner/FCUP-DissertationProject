...
\thesistitle{System For Pratical Evaluations of Network Administration Course}

% Your thesis type Doctoral Thesis or Masters Thesis \ttype
\thesistype{Masters Thesis}

% Your supervisor's name
\supervisor[mailto:rcprior@fc.up.pt]{Rui \textsc{LastName}}
...
% Your name
\authors[mailto:up202007895@fc.up.pt]{Diogo \textsc{MyLastName}}
